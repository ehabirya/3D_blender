...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    # Quiet the linter while preserving behavior if PYTHONPATH is unset
...
# (keeps your original filenames; no handler renaming)
COPY *.py /app/
...
# ---- Runtime env & command (unchanged handler name) ----
ENV BLENDER_BIN=/blender/blender

# Keep your existing entrypoint that RunPod will execute inside Serverless
# (no renaming to rp_handler.py)
